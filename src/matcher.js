const RULES = [
  ...
  ["graduation_year", /graduat.*(year|date)/i], ["school", /school|university|college|institution/i],
  ["field_of_study", /field\s*of\s*study|major/i], ["employer", /employer|company/i], ["job_title", /job\s*title|position\s*title/i],
